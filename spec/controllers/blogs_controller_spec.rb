...
describe Slate::BlogsController do
  describe "POST create" do
    ...
    context "with invalid attributes" do
      it "doesn't create a new blog" do
        expect{
          post :create, :use_route => :slate, blog: attributes_for(:blog, :title => nil, :author_id => nil)
        }.to_not change(Slate::Blog, :count)
  ...
  describe "PUT update" do
    ...
    context "with valid attributes" do
      it "changes blog's attributes" do
        put :update, id: @blog.id, :use_route => :slate,
            blog: attributes_for(:blog, title: "Testz")
        @blog.reload
        @blog.title.should eq("Testz")
      end
      it "redirects to the site root" do
        put :update, :use_route => :slate, id: @blog.id, blog: attributes_for(:blog)
        response.should redirect_to root_url
      end
    end
    context "with invalid attributes" do
  ...
  describe "GET spam" do
    ...
    it "returns spam comments" do
      get :spam, :use_route => :slate, id: @blog.id
